                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                           <strong>Welcome <c:out value="${pageContext.request.userPrincipal.name}"></c:out> ! </strong> You Have <c:out value="${count}"/> pending New Messages.s.
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="broadcast">
                                <h4>Broadcast message to entire project team</h4>
                                 <form method="post" action="${pageContext.request.contextPath }/Broadcast">
                               <p>
                             ...
                             <div class="tab-pane fade" id="closure">
                                <h4>Project closure</h4>
                                 <form method="post" action="${pageContext.request.contextPath }/Closure">
                                <p>
                                   <select name="project" class="form-control">
                              <c:forEach var="p" items="${proj_list }">
                               <option value='<c:out value="${p.getId() }"/>'><c:out value="${p.getName() }"/> </option>
